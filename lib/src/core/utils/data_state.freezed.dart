...
mixin _$DataState<T> {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(T data, Map<String, dynamic> response) success,
    required TResult Function(AppError data) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data, Map<String, dynamic> response)? success,
...
abstract class _$$SuccessImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({T data, Map<String, dynamic> response});
}
...
class _$SuccessImpl<T> implements Success<T> {
  const _$SuccessImpl(this.data, final Map<String, dynamic> response)
      : _response = response;
  ...
  @override
  String toString() {
    return 'DataState<$T>.success(data: $data, response: $response)';
  }
...
abstract class Success<T> implements DataState<T> {
  const factory Success(final T data, final Map<String, dynamic> response) =
      _$SuccessImpl<T>;
