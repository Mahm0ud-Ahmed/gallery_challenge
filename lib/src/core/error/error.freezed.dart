...
class _$ErrorModelImpl implements ErrorModel {
  const _$ErrorModelImpl({this.statusCode, this.errorMessage});
  ...
  @override
  String toString() {
    return 'AppError(statusCode: $statusCode, errorMessage: $errorMessage)';
  }
...
abstract class ErrorModel implements AppError {
  const factory ErrorModel(
      {final int? statusCode, final String? errorMessage}) = _$ErrorModelImpl;
