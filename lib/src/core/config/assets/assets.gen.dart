...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/camera_login.png
  AssetGenImage get cameraLogin => const AssetGenImage('assets/images/camera_login.png');

  /// File path: assets/images/circuler.svg
  SvgGenImage get circuler => const SvgGenImage('assets/images/circuler.svg');

  /// File path: assets/images/gallery.png
  AssetGenImage get gallery => const AssetGenImage('assets/images/gallery.png');

  /// File path: assets/images/image_placeholder.svg
  SvgGenImage get imagePlaceholder => const SvgGenImage('assets/images/image_placeholder.svg');

  /// File path: assets/images/logout.svg
  SvgGenImage get logout => const SvgGenImage('assets/images/logout.svg');

  /// File path: assets/images/threads.svg
  SvgGenImage get threads => const SvgGenImage('assets/images/threads.svg');
