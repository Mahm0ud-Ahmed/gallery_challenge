...
class _$ApiDataLoadingImpl<T> implements ApiDataLoading<T> {
  const _$ApiDataLoadingImpl({this.count, this.total});
  ...
  @override
  String toString() {
    return 'ApiDataState<$T>.loading(count: $count, total: $total)';
  }
...
abstract class ApiDataLoading<T> implements ApiDataState<T> {
  const factory ApiDataLoading({final int? count, final int? total}) =
...
class _$ApiDataSuccessModelImpl<T> implements ApiDataSuccessModel<T> {
  const _$ApiDataSuccessModelImpl({this.data});
  ...
  @override
  String toString() {
    return 'ApiDataState<$T>.success(data: $data)';
  }
...
abstract class ApiDataSuccessModel<T> implements ApiDataState<T> {
  const factory ApiDataSuccessModel({final T? data}) =
